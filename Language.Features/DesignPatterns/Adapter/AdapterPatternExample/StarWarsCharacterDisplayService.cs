...
{
    private readonly ICharecterSourceAdapter _sourceAdapter;

    public StarWarsCharacterDisplayService(ICharecterSourceAdapter sourceAdapter)
    {
    ...
    {
        var people = await _sourceAdapter.GetCharacters();
